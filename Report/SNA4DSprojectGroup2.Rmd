...
### Importance 
As mentioned, humanity has always moved a lot, however the amount of migration has increased with time. In 2020, it was estimated that 281 million people live in a country that is not their country of birth (United Nations & Nations, 2019). This is over three times the estimated number in 1970. With this increase in migration, come a lot of other changes, since migration has different effects on a country. For example, research has shown that skilled migrants have a positive effect on innovation (Fassio et al., 2019). Besides that there are effects on the economy, since migration "boosts the working-age population" and "contributes to technological progress" (OECD, 2014).

...
tech2.mcmc <- ergm::mcmc.diagnostics(tech2)
knitr::kable(tech2.mcmc)

tech3.mcmc <- ergm::mcmc.diagnostics(tech3)
knitr::kable(tech3.mcmc)

tech4.mcmc <- ergm::mcmc.diagnostics(tech4)
knitr::kable(tech4.mcmc)

tech5.mcmc <- ergm::mcmc.diagnostics(tech5)
knitr::kable(tech5.mcmc)
```

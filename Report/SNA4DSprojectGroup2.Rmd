...
::: {style="text-align: justify"}
The centrality of Austria was estimated by the stress centrality measure. The centrality was calculated for every country in the network, in each decade that is represented in the dataset. 

**Show table with centrality measures**
:::

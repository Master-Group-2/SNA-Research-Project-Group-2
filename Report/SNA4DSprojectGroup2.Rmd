...
All the data and code can be found on the following GitHub repository: https://github.com/Master-Group-2/SNA-Research-Project-Group-2. For each part of the process, a different branch has been created.
:::

## Executive Summary

::: {style="text-align: justify"}
A social network analysis of migration in Europe from 1960 to 2000 has been conducted to investigate the patterns and trends of migration during this period. The study focused on two main research questions:
"Does Austria have a high centrality in the social network of Europe's migration", and "does the technical development of a country have a positive effect on the level of migration to that country over time"? To investigate the research questions CUG and ERGM models were created to check the hypotheses. The results of the study did not support the hypothesis that Austria has a high centrality in the social network of Europe's migration. The hypothesis that the technical development of a country has a positive effect on the level of migration, also could not be proven. The lack of results raises questions about Europe migration
reasons for future academic research. Overall, the study provides new insights into the trends of migration in Europe during the period under review.
:::
...
After this section, the methodology will be discussed, where the data is shown, as well as the approach used for the methods. Next will be the results, where model summaries, as well as model diagnostics, are discussed. These results will then be linked to the hypotheses created in the preceding sections. Finally, a conclusion will be drawn, where learnings from these models are presented, as well as some limitations and recommendations for future work. 
:::

...
```
::: {style="text-align: justify"}
To be able to answer the hypothesis, both the coefficients as well as the significance need to be taken into account. 
For the technological development, the focus first needs to be on the telephone subscriptions variable, after that the mobile subscriptions and the internet subscriptions are more representative. For these variables, the three different dyad states are displayed, namely mutual, upper-triangular asymmetric, and lower-triangular asymmetric dyads. 

Besides these results, it is also important to have a look at the diagnostics of the model. Firstly, the MCMC diagnostics will be displayed, after that the GOF diagnostics. 
